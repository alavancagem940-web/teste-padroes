...
export const LEAGUES = {
  ...
  mls: { label: 'MLS', sport: 'soccer_usa_mls', tier: 1 },
  'champions-league': { label: 'Champions League', sport: 'soccer_uefa_champs_league', tier: 1, cup: true },
  'europa-league': { label: 'Europa League', sport: 'soccer_uefa_europa_league', tier: 1, cup: true },
  'conference-league': { label: 'Conference League', sport: 'soccer_uefa_europa_conference_league', tier: 1, cup: true },
  libertadores: { label: 'Libertadores', sport: 'soccer_conmebol_copa_libertadores', tier: 1, cup: true },
  'sul-americana': { label: 'Sul-Americana', sport: 'soccer_conmebol_copa_sudamericana', tier: 1, cup: true },
  'copa-do-brasil': { label: 'Copa do Brasil', sport: null, tier: 1, cup: true, publicOnly: true }
};
...
export const MAJOR_CUPS = ['champions-league', 'europa-league', 'conference-league', 'libertadores', 'sul-americana', 'copa-do-brasil'];
...
async function fetchTimed(url, timeoutMs = 4300) {
...
export async function getLeagueOdds(leagueKey) {
  ...
  if (!league.sport) { const error = new Error(`${league.label} usa calendário público neste projeto; odds reais entram quando uma fonte compatível estiver disponível.`); error.code='ODDS_SPORT_UNAVAILABLE'; throw error; }
